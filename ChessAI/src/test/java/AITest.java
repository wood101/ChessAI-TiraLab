...
public class AITest {
    ...
    public void testFoolsMate() {
        ...
        final MoveTransition expectedMove = board.currentPlayer().makeMove(Move.MoveFactory.createMove(board, BoardUtility.getCoordinateAtPosition("D8"), BoardUtility.getCoordinateAtPosition("H4")));
